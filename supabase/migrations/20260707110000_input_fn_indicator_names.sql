-- =============================================================================
-- Migration 0011 : compute_score_input() renvoie les noms lisibles
-- -----------------------------------------------------------------------------
-- Les indicateurs applicables portent désormais name + unit, pour que la fiche
-- web affiche « Politique sans fourrure » plutôt que ANI_FUR_FREE.
-- =============================================================================
